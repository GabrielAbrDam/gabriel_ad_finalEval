...
if(!empty($_POST))
{
    ...
    { 	// error = 0 = insertion user
    	$db = 'INSERT INTO users (gender, firstname, lastname, email, birthdate, city) VALUES(:gender, :firstname, :lastname, :email, :birthdate, :city)';
    	$insertUser = $connection->prepare($db);
